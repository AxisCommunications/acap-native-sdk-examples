...
This README file explains how to build an ACAP4 Native application that uses the licensekey API. It is achieved by using the containerized API and toolchain images.
